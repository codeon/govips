# govips [![Build Status](https://travis-ci.org/codeon/govips.svg)](https://travis-ci.org/codeon/govips) [![GoDoc](https://godoc.org/github.com/codeon/govips?status.svg)](https://godoc.org/github.com/codeon/govips) [![Go Report Card](http://goreportcard.com/badge/codeon/govips)](http://goreportcard.com/report/codeon/govips) ![License](https://img.shields.io/badge/license-MIT-blue.svg)
...
# Installation
```bash
go get -u github.com/codeon/govips/pkg/vips
```
...
# Contributing
In short, feel free to file issues or send along pull requests. See this [guide on contributing](https://github.com/codeon/govips/blob/master/CONTRIBUTING.md) for more information.
